...
export default function ArticleForm({ id, loggedUser }: {id: string, loggedUser: string}) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setMessage({ type: 'error', text: 'An error occurred while adding the article: ' + error });
        } finally {
    ...
    if (loading) {
        return <div className="text-gray-700 dark:text-gray-300">Loading data...</div>;
    }
            ...
            <div className="w-full">
                ...
                <form onSubmit={handleSubmit} className="max-w-3xl mx-auto p-8 bg-gray-100 dark:bg-gray-800 rounded-xl shadow-lg">
                    ...
                    <div className="space-y-6">
                        ...
                        <div>
                            <label htmlFor="written_by" className="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-1">
