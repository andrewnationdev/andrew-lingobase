...
const ipaVowelChart = [
	{ label: "Close", cells: ["i", "ɨ", "ɯ", "u"] },
	{ label: "Near-close", cells: ["ɪ", "ʉ", "ʊ"] },
	{ label: "Close-mid", cells: ["e", "ə", "ɤ", "o"] },
	{ label: "Mid", cells: ["ɛ", "ɜ", "ʌ"] },
	{ label: "Open-mid", cells: ["æ", "ɐ", "ɑ"] },
	{ label: "Open", cells: ["a", null, "ɒ"] },
];
