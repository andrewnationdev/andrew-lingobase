...
export default function DictionaryForm({ conlang_code, owner }) {
    ...
    return (
        <form onSubmit={handleSubmit} className="w-full mx-auto p-4 bg-gray-100 dark:bg-gray-800 rounded-xl shadow-lg">
            <div className="space-y-6">
                <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-200">Add a New Word</h2>
                ...
                {/* Transliteration */}
                <div>
                    <label htmlFor="transliteration" className="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-1">Transliteration</label>
                    <input
                        type="text"
