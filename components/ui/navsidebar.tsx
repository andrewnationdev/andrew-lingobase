...
import { faHouse, faAdd, faUser, faMessage } from '@fortawesome/free-solid-svg-icons';
...
const navItems = [
    ...
    { id: 4, icon: faMessage, link: "https://discord.gg/6BEpySdDdv"}
];
...
const SidebarNav = () => {
  ...
  "
                >
                    <FontAwesomeIcon 
                        icon={item.icon} 
                        className="!text-sm transition-colors duration-200 group-hover:text-blue-500" 
                    />
                </Link>
            ))}
        </nav>
